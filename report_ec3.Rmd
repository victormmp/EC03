...
```{r plot, echo=F, fig=T, fig.align='center', fig.cap='Q-Q plot.', fig.pos="H"}
qqPlot(difs)
```
...
```{r boxplot, echo=F, fig=T, fig.align='center', fig.cap='Boxplot para as diferenças das médias.', fig.pos="H"}
boxplot(difs)
```
